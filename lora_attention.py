...
# Copied from diffusers.models.attention_processor.LoRALinearLayer
...
class CLIPLoRAAttention(CLIPAttention):
    ...
    def __init__(self, config):
        super().__init__()
        # TODO: update attribute `lora_rank` in config
        rank = config.lora_rank
        self.lora_k_proj = LoRALinearLayer(self.embed_dim, self.embed_dim, rank)
        self.lora_v_proj = LoRALinearLayer(self.embed_dim, self.embed_dim, rank)
        self.lora_q_proj = LoRALinearLayer(self.embed_dim, self.embed_dim, rank)
        self.lora_out_proj = LoRALinearLayer(self.embed_dim, self.embed_dim, rank)
